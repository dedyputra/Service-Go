...
{
	if (
		'boxed' == get_theme_mod('ocean_main_layout_style', 'wide')
...
{
	if (
		'wide' == get_theme_mod('ocean_main_layout_style', 'wide')
		|| 'separate' == get_theme_mod('ocean_main_layout_style', 'wide')
	) {
		return true;
	} else {
...
{
	if (
		'one' == get_theme_mod('ocean_menu_links_effect', 'no')
...
{
	if (
		'two' == get_theme_mod('ocean_menu_links_effect', 'no')
...
{
	if (
		true == get_theme_mod('ocean_footer_widgets', true)
